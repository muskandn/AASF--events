      ...
      <div>
        ...
        <div className='abhishar-tabs-container'>
          <div className='abhishar-tab'>
            <CustomButton
              CustomButtom__onClickFunction={aboutFunction}
              customButton__text='About'
            />
          </div>
          <div className='abhishar-tab'>
            <CustomButton
              CustomButtom__onClickFunction={abhisharFunction}
          ...
          <Fade left>
            <div className='abhisharpage-content-box'>
              ...
              <div className='abhisharpage-text secondary-font'>
                ...
                Saxena and Tushar Sharma -two indispensable work engines of
                AASF.
              </div>
            </div>
          </Fade>
